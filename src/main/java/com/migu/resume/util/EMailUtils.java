...
public class EMailUtils {
     ...
     */
    public EMailUtils(String smtpHost, String sendUserName, String sendPassWord,
            boolean debug) {
    ...
    public static void main(String[] args) {
        ...
        String sender_username = "itic_admin@163.com";
        String sender_password = "admin123";
        String[] files = { "G:\\测试.jpg", "G:\\测试.jpg" };
        String[] toUser = { "610976665@qq.com" };
        // String[] toCopy = { "5103505@qq.com",
        // "2017724298@qq.com","610976665@qq.com" };
        // 正文附件
        Map<String, String> map = new HashMap<String, String>();
        map.put("a00000001", "G:\\测试.jpg");
        EMailUtils se = new EMailUtils(mailHost, sender_username, sender_password, true);
        se.doSendHtmlEmail(
                "邮件主题",
                "<div style='background-color:red;'>abcde</div><img alt='' src='cid:a00000001'></img>",
                toUser, files, null, map);//
    }
