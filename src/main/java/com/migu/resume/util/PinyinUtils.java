...
public class PinyinUtils {
    ...
    public static String stringToPinyin(String src) {
        return stringArrayToString(stringToPinyin(src, false, null));
    }
    /**
     * 将字符串转换成拼音数组
    ...
    public static String stringToPinyin(String src,String separator) {
        return stringArrayToString(stringToPinyin(src, false, separator));
    }
    ...
    private static String cnToPinyin(String hanzi){
        return cnToPinyin(hanzi," ");
    }
    /**
     * 将汉字转换成拼音
     * @param hanzi
     ...
     * @return
     */
    private static String cnToPinyin(String hanzi,String separator){
        // 创建汉语拼音处理类
     ...
     * @return
     */
    private static char[]  getHeadByChar(char src){
    ...
    public  static String getHeadByString(String src){
        return stringArrayToString(getHeadByString( src, true,null));
    }
    /**
     * 查找字符串首字母
     * @param src
    ...
    public  static String getHeadByString(String src,boolean isCapital){
        return stringArrayToString(getHeadByString( src, isCapital,null));
    }
    /**
     * 查找字符串首字母
     * @param src
    ...
    public static void main(String[] args) {
        System.out.println((getHeadByString("我的心肝爱上,ba会计")));
    }
